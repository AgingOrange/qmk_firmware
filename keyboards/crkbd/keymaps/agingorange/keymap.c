...
tap_dance_action_t tap_dance_actions[] = {[TD_WSPC] = ACTION_TAP_DANCE_DOUBLE(G(KC_3), G(KC_2)), [TD_LOUT] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, dance_layer_to_qwerty, dance_layer_to_colemak)};
